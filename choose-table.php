                          ...
                          <ul>
                            <?php 
                              ...
                              foreach ($result2 as $r2) {
                                  $c_id = $r2['id'];
                                $booked = false;
                                $cbbook = "SELECT `id`, `booking_id`, `chair_id`, `chair_no`, (SELECT booking_date FROM booking_details WHERE booking_chair.booking_id = booking_details.booking_id AND booking_details.booking_date = '$reservation_date') as bdate, (SELECT booking_time FROM booking_details WHERE booking_chair.booking_id = booking_details.booking_id AND booking_details.booking_time = '$reservation_time') as btime FROM `booking_chair` where booking_chair.chair_id  = '$c_id';";
